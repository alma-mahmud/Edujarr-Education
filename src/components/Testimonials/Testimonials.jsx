...
function Testimonials() {
  ...
  return (
    <>
    <section className='pb-10 px-5 lg:pb-30 bg-linear-to-b from-white to-[rgba(128,87,216,0.34)]'>
  <div>
    <div className='text-center'>
      <h3 className='text-[#2AAA94] text-[30px] lg:text-[45px] font-rowdies leading-13.75 font-bold'>
        Testimonials
      </h3>
      <p className='text-[#4E596B] text-[18px] lg:text-[25px] font-saira font-medium leading-10 pb-10 lg:pb-22.75'>
